...
export const MSG = Object.freeze({
  ...
  // Reward auto-claim
  CHZZK_REWARD_REGISTER: 'CHZZK_REWARD_REGISTER',
  CHZZK_REWARD_HEARTBEAT: 'CHZZK_REWARD_HEARTBEAT',
  CHZZK_REWARD_UNREGISTER: 'CHZZK_REWARD_UNREGISTER',
  CHZZK_REWARD_RUN: 'CHZZK_REWARD_RUN',
